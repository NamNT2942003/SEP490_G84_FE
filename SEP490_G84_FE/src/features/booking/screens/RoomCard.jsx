const RoomCard = ({ room, onBooking, onViewDetail }) => {
    ...
    return (
        ...
        .rc-pricing { flex: 0 0 350px; padding: 28px; display: flex; flex-direction: column; gap: 16px; background: var(--bg-light); border-left: 1px solid #f0f0f0; }
        ...
        .rc-opt { background: #fff; border: 1.5px solid #edf2f7; border-radius: 16px; padding: 18px; transition: all 0.2s; position: relative; overflow: hidden; }
        ...
        .rc-opt-header { background: #f8fafc; padding: 8px 12px; border-radius: 10px; margin-bottom: 12px; display: inline-block; }
        ...
        .rc-opt-meta { margin-bottom: 16px; display: flex; flex-direction: column; gap: 6px; }
        ...
        .rc-opt-book { width: 100%; padding: 12px; border: none; border-radius: 12px; background: var(--olive); color: #fff; font-weight: 700; font-size: 0.9rem; cursor: pointer; transition: all 0.2s; display: flex; justify-content: center; align-items: center; gap: 8px; }
        ...
        @media(max-width:1100px) { .rc-row { flex-direction: column; } .rc-img { flex: auto; height: 260px; } .rc-pricing { flex: auto; border-left: none; border-top: 1px solid #f0f0f0; } }
      `}</style>
            <div className="rc">
