...
export default function AmendmentRequestsModal({ show, requests = [], onClose, onOpenAmendment }) {
    if (!show) return null;
        ...
        <div className="bm-modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
            <div className="bm-modal" style={{ width: "min(980px, 96vw)" }}>
                <div className="bm-modal-header">
                    <div>
                        <h5 className="mb-0 fw-bold">Amendment Requests</h5>
                        <div className="text-muted small">Guest requests waiting for staff to process</div>
                    </div>
                ...
                <div className="bm-modal-body" style={{ maxHeight: "70vh", overflowY: "auto" }}>
                    {requests.length === 0 ? (
                        <div className="text-center py-5 text-muted">
                            ...
                            No amendment requests right now.
                        </div>
                    ) : (
                            ...
                            {requests.map((booking) => (
                                <div
                                    ...
                                    style={{
                                        ...
                                        borderColor: "rgba(13,110,253,0.30)",
                                        borderLeftWidth: "5px",
                                    }}
                                >
                                    ...
                                    {/* Guest note */}
                                    {booking.raw?.amendmentRequestNote && (
                                        <div
                                        ...
                                        >
                                            <div className="fw-semibold small mb-1" style={{ color: "#0d6efd" }}>
                                    ...
                                    <div className="d-flex justify-content-end gap-2">
                                        <Buttons
                                            ...
                                            onClick={() => onOpenAmendment?.(booking.bookingId)}
                                        >
                                            Open amendment
                                        </Buttons>
                                    </div>
