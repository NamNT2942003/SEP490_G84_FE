...
const PAYMENT_OPTIONS = [
  {
    ...
    sub: 'Settle at checkout',
  },
  {
    value: 'pay_now',
    icon: 'bi-cash-coin',
    title: 'Pay Now',
    sub: 'Collect immediately',
  },
];
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '24px 28px', background: C.bg }}>
          ...
          <div style={{
                ...
                return (
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      <div>
                        <div style={{ fontSize: 13.5, fontWeight: 700, color: active ? C.primary : C.text }}>
                          {opt.title}
                        </div>
                      ...
                      {active && (
                        <i className="bi bi-check-circle-fill ms-auto" style={{ color: C.primary, fontSize: 16 }} />
                      )}
                    </div>
                  </button>
                );
            ...
            {/* Choose payment method if pay_now */}
