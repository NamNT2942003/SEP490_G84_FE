        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1000 }}>
            <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '8px', width: '400px', maxWidth: '90%' }}>
                ...
                <div style={{ marginBottom: '16px', lineHeight: '1.8' }}>
                    ...
                    <div><strong>Unit price:</strong> <span style={{ color: '#d97706', fontWeight: 'bold' }}>{formatCurrency(item.price)}</span></div>
                    ...
                    <div><strong>Opening stock:</strong> {item.beginStock}</div>
                    <div><strong>Imported:</strong> {item.importedQty}</div>
                    <div><strong>Closing stock:</strong> {item.endingStock}</div>
                </div>
